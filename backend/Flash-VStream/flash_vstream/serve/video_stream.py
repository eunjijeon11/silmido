...
def video_stream_simulator(video_file, frame_queue, log_queue, video_fps=1.0, play_speed=1.0):
    ...
    logger.info(f'Simulator Process: start, length = {video.shape}')
...
def main(args):
    ...
    with Manager() as manager:
        ...
        p2 = Process(target=video_stream_simulator, 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="Flash-VStream-7b")
    parser.add_argument("--model-base", type=str, default=None)
    parser.add_argument("--image-file", type=str, default=None)
    parser.add_argument("--video-file", type=str, default="assets/example.mp4")
